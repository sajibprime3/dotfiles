    ...
    opts = {
      setup = {
        jdtls = function(_, opts)
          ...
          -- Get path to lombok.jar from jdtls package
          local jdtls_pkg = mason_registry.get_package("jdtls")
          local lombok_path = jdtls_pkg:get_install_path() .. "/lombok.jar"

          -- Inject lombok as Java agent
          opts.cmd = {
            "jdtls",
            "-configuration",
            ...
            java = {
              ...
              jdt = {
                ls = {
                  ...
                  -- protofBufSupport?: EnableOptions;
          ...
          print(opts.capabilities)
          lspconfig.jdtls.setup(opts)
          return true -- prevents LazyVim from overriding this
        end,
      },
    },
  },
